    ...
    <footer className="bg-gray-900 text-gray-300 border-t border-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-6 sm:gap-8 py-8">
          <Image src="/logo-1-tpb.jpg" alt="Tax Practitioners Board" width={110} height={44} className="h-10 w-auto object-contain opacity-70 hover:opacity-100 transition-opacity duration-300" />
          <div className="hidden sm:block w-px h-7" style={{ backgroundColor: "rgba(255,255,255,0.08)" }} />
          <Image src="/logo-2-smsf.jpg" alt="SMSF Association Specialist" width={110} height={44} className="h-10 w-auto object-contain opacity-70 hover:opacity-100 transition-opacity duration-300" />
          <div className="hidden sm:block w-px h-7" style={{ backgroundColor: "rgba(255,255,255,0.08)" }} />
          <Image src="/logo-3-cpa.jpg" alt="CPA Australia" width={110} height={44} className="h-10 w-auto object-contain opacity-70 hover:opacity-100 transition-opacity duration-300" />
        </div>
